...
public class TaikaiJyQualifier extends FancyQualifier {
	public static final String DEFAULT_SERVICE_PREFIX = ServicePrefix.TAIKAI;
	...
	public static final String DISTRIBUTION_CLIENT_WORKER = DEFAULT_SERVICE_PREFIX + "DistributionClientWorker";
	...
	public static final String CURRENT_PLACE_SERVICE = DEFAULT_SERVICE_PREFIX + "CurrentPlaceService";
}
