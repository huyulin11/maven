...
public class PageTag extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			html = MessageFormat.format(html, first, previous, next, last, String.valueOf(curpage),
					String.valueOf(totalPages), String.valueOf(pagesize), String.valueOf(totalLines));
