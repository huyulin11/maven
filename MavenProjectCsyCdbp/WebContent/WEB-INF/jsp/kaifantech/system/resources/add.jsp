...
<script src="/s/j/jquery/jquery-validation/jquery.validate.min.js"></script>
<style type="text/css">
#but button {
	margin-bottom: 5px;
	margin-right: 5px;
...
<body>
	...
	<script type="module">
		import "/s/j/system/resources/resources.add.js";
	</script>
	<script type="module">
		import {byRes} from "/s/j/system/resources/getResList.js";
